...
_VERSION_LABEL = 'V8.5.2' if _RELEASE_CHANNEL else 'V8.5.2 Candidate'
...
_output_name = (('pemark_x64_v8_5_2_outline_alloc_%s.exe' % ARENA_ALLOC_INJECTION_MODE)
                ...
                'pemark_x64_v8_5_2_open_transaction_test.exe' if OPEN_TEST_BUILD
                      ...
                      'pemark_x64_v8_5_2.exe' if _RELEASE_CHANNEL else
                      'pemark_x64_v8_5_2_candidate.exe'))
...
_map_name = 'PE_MEMORY_MAP_V8_5_2.md' if _RELEASE_CHANNEL else 'PE_MEMORY_MAP_V8_5_2_CANDIDATE.md'
