...
_output_name = (('pemark_x64_v8_6_3_outline_alloc_%s.exe' % ARENA_ALLOC_INJECTION_MODE)
                if OUTLINE_ALLOC_INJECTED else
                ('pemark_x64_v8_6_3_style_alloc_%s.exe' % ARENA_ALLOC_INJECTION_MODE)
                if STYLE_ALLOC_INJECTED else
                ('pemark_x64_v8_6_3_render_alloc_%s.exe' % ARENA_ALLOC_INJECTION_MODE)
                if RENDER_ALLOC_INJECTED else
                ('pemark_x64_v8_6_3_document_alloc_%s.exe' % ARENA_ALLOC_INJECTION_MODE)
                if DOCUMENT_ALLOC_INJECTED else
                ('pemark_x64_v8_6_3_wide_alloc_%s.exe' % ARENA_ALLOC_INJECTION_MODE)
                if WIDE_ALLOC_INJECTED else
                ('pemark_x64_v8_6_3_byte_alloc_%s.exe' % ARENA_ALLOC_INJECTION_MODE)
                if BYTE_ALLOC_INJECTED else
                ('pemark_x64_v8_6_3_open_read_%s.exe' % OPEN_READ_INJECTION_MODE)
                if OPEN_READ_INJECTION_MODE != 'release' else
                'pemark_x64_v8_6_3_open_transaction_test.exe' if OPEN_TEST_BUILD
                else ('pemark_x64_v8_6_3_write_%s.exe' % WRITE_INJECTION_MODE
