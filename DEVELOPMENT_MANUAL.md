...
V8.5.4 uses the expanded layout documented in
`docs/PE_MEMORY_MAP_V8_5_4.md`. A code-overlap exception remains a
...
- V8.5.4: current public Preview baseline (document safety).
- V8.5.4: dynamic capacity. V8.5.4: PE hardening.
