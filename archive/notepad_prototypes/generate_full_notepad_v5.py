...
wstr('title','Direct PE Notepad x64 V5 — No Compiler')
wstr('empty','')
wstr('menu_file','&File')
wstr('menu_edit','&Edit')
wstr('menu_view','&View')
...
wstr('m_zoom','&Zoom')
wstr('m_zoomin','Zoom &In\tCtrl++')
wstr('m_zoomout','Zoom &Out\tCtrl+-')
...
wstr('about','Direct PE Notepad x64 V5\r\n\r\nNative PE32+ and x86-64 machine code generated directly, without a C/C++ compiler, assembler, or linker.\r\n\r\nV5 adds live resize, character/selection counts, accelerators, and native Find / Replace dialogs.')
...
# ---------------- PE writer ----------------
# ---------------- PE writer (v5: one loader-simple section) ----------------
...
out = '/mnt/data/direct_pe_notepad_full_x64_v5.exe'
