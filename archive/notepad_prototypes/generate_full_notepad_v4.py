...
wstr('title','Direct PE Notepad x64 V4 — No Compiler')
wstr('empty','')
wstr('menu_file','&File')
wstr('menu_edit','&Edit')
wstr('menu_view','&View')
...
wstr('m_zoom','&Zoom')
wstr('m_zoomin','Zoom &In')
wstr('m_zoomout','Zoom &Out')
wstr('m_zoomreset','Restore &Default Zoom')
wstr('m_wrap','&Word Wrap')
wstr('m_status','&Status Bar')
wstr('m_about','&About')
...
add_bytes('status_parts', struct.pack('<iiii', 240, 330, 470, -1), 4)
...
imports = {
    ...
    'USER32.dll': [
        ...
        'DestroyWindow','ShowWindow','CheckMenuItem','GetWindowRect','wsprintfW'
    ],
...
em.mov_r64_r64('rcx','rax'); em.mov_r32_imm('rdx',0x0404); em.mov_r32_imm('r8',4); em.lea_rip('r9',rsyms['status_parts']); em.call_iat('SendMessageW')
...
em.cmp_r32_imm('rax',0x8002); em.jcc(0x84,'resize_event') # WM_APP+2 posted by wndproc
em.jmp('dispatch')
...
# Helper: Windows-Notepad-style status fields: line/column, zoom, EOL, encoding.
...
em.mov_r64_ripmem('rcx',bsyms['hwnd_status']); em.mov_r32_imm('rdx',0x040B); em.mov_r32_imm('r8',1); em.lea_rip('r9',bsyms['status_zoombuf']); em.call_iat('SendMessageW')
# line endings
em.mov_r64_ripmem('rcx',bsyms['hwnd_status']); em.mov_r32_imm('rdx',0x040B); em.mov_r32_imm('r8',2); em.lea_rip('r9',rsyms['status_crlf']); em.call_iat('SendMessageW')
# encoding
...
em.label('enc_send'); em.mov_r64_ripmem('rcx',bsyms['hwnd_status']); em.mov_r32_imm('rdx',0x040B); em.mov_r32_imm('r8',3); em.call_iat('SendMessageW')
em.label('status_ret'); em.add_r64_imm8('rsp',0x28); em.emit(0xC3)

em.label('exit')
em.mov_r64_ripmem('rcx',bsyms['hfont']); em.test64('rcx'); em.jcc(0x84,'exit_now'); em.call_iat('DeleteObject')
...
em.label('wp_size')
# Store client dimensions and queue resizing; the main routine owns child/layout state.
em.mov_r32_r32('r10','r9'); em.mov_r32_r32('r11','r9'); em.and_r32_imm('r10',0xFFFF); em.shr_r32_imm8('r11',16)
em.mov_ripmem_r32(bsyms['client_w'],'r10'); em.mov_ripmem_r32(bsyms['client_h'],'r11')
em.mov_r32_imm('rdx',0x8002); em.xor32('r8'); em.xor32('r9'); em.call_iat('PostMessageW')
em.xor32('rax'); em.add_r64_imm8('rsp',0x38); em.emit(0xC3)
...
# ---------------- PE writer ----------------
# ---------------- PE writer (v4: one loader-simple section) ----------------
...
out = '/mnt/data/direct_pe_notepad_full_x64_v4.exe'
