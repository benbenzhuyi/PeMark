...
wstr('title','Direct PE Markdown Editor x64 V8.4.8 — No Compiler')
wstr('empty','')
wstr('menu_file','&File')
wstr('menu_edit','&Edit')
...
em.mov_r64_ripmem('rcx',bsyms['hwnd_outline']); em.mov_r32_imm('rdx',0x0197); em.xor32('r9'); em.call_iat('SendMessageW'); em.jmp('msg_loop')
...
out = '/mnt/data/direct_pe_markdown_editor_x64_v8_4_8.exe'
