...
wstr('title','Direct PE Markdown Editor x64 V8.4.6 — No Compiler')
wstr('empty','')
wstr('menu_file','&File')
wstr('menu_edit','&Edit')
...
# Comfortable 12px left/right document inset (EM_SETMARGINS, EC_LEFT|EC_RIGHT).
em.mov_r64_r64('rcx','rsi'); em.mov_r32_imm('rdx',0x00D3); em.mov_r32_imm('r8',3); em.mov_r32_imm('r9',0x000C000C); em.call_iat('SendMessageW')
...
# Back to Markdown source editing mode. Preserve logical line/column from Preview.
em.mov_r64_ripmem('rcx',bsyms['hwnd_preview']); em.call_label('capture_view_anchor')
em.mov_ripmem_imm32(bsyms['preview_flag'],0)
...
em.call_label('resize_children'); em.mov_r64_ripmem('rcx',bsyms['hwnd_edit']); em.call_label('restore_view_anchor'); em.mov_r64_ripmem('rcx',bsyms['hwnd_edit']); em.call_iat('SetFocus'); em.jmp('msg_loop')
em.label('preview_show')
# Full-window rendered Markdown mode. Capture Source line/column before rendering,
# then restore the equivalent logical position in the read-only Preview.
em.call_label('sync_model_from_editor')
em.mov_r64_ripmem('rcx',bsyms['hwnd_edit']); em.call_label('capture_view_anchor')
...
em.call_label('resize_children'); em.mov_r64_ripmem('rcx',bsyms['hwnd_preview']); em.call_label('restore_view_anchor'); em.mov_r64_ripmem('rcx',bsyms['hwnd_preview']); em.call_iat('SetFocus'); em.jmp('msg_loop')
...
out = '/mnt/data/direct_pe_markdown_editor_x64_v8_4_6.exe'
