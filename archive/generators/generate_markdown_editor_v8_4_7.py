...
wstr('title','Direct PE Markdown Editor x64 V8.4.7 — No Compiler')
wstr('empty','')
wstr('menu_file','&File')
wstr('menu_edit','&Edit')
...
# Comfortable 20px left/right Source inset (EM_SETMARGINS, EC_LEFT|EC_RIGHT).
em.mov_r64_r64('rcx','rsi'); em.mov_r32_imm('rdx',0x00D3); em.mov_r32_imm('r8',3); em.mov_r32_imm('r9',0x00140014); em.call_iat('SendMessageW')
...
# Same document inset in rendered mode.
em.mov_r64_ripmem('rcx',bsyms['hwnd_preview']); em.mov_r32_imm('rdx',0x00D3); em.mov_r32_imm('r8',3); em.mov_r32_imm('r9',0x000C000C); em.call_iat('SendMessageW')
...
# Apply Source text gutter after WM_SETFONT so it cannot be reset by the font change.
em.mov_r64_r64('rcx','rsi'); em.mov_r32_imm('rdx',0x00D3); em.mov_r32_imm('r8',3); em.mov_r32_imm('r9',0x00140014); em.call_iat('SendMessageW')
...
# Preview -> Source: map the rendered caret/selection back to the exact source-producing UTF-16 index.
em.mov_r64_ripmem('rcx',bsyms['hwnd_preview']); em.mov_r32_imm('rdx',0x00B0); em.lea_rip('r8',bsyms['view_sel_start']); em.lea_rip('r9',bsyms['view_sel_end']); em.call_iat('SendMessageW')
...
em.mov_r64_ripmem('rcx',bsyms['hwnd_edit']); em.mov_r32_imm('rdx',0x00B1); em.mov_r32_ripmem('r8',bsyms['view_sel_start']); em.mov_r32_ripmem('r9',bsyms['view_sel_end']); em.call_iat('SendMessageW')
...
# Source -> Preview: remember absolute Source selection, build Preview + its monotonic source map,
# then convert the caret to a rendered offset. Word-wrap no longer affects the mapping.
em.call_label('sync_model_from_editor')
em.mov_r64_ripmem('rcx',bsyms['hwnd_edit']); em.mov_r32_imm('rdx',0x00B0); em.lea_rip('r8',bsyms['view_sel_start']); em.lea_rip('r9',bsyms['view_sel_end']); em.call_iat('SendMessageW')
...
em.call_label('resize_children')
em.mov_r64_ripmem('rcx',bsyms['hwnd_preview']); em.mov_r32_imm('rdx',0x00B1); em.mov_r32_ripmem('r8',bsyms['view_sel_start']); em.mov_r32_ripmem('r9',bsyms['view_sel_end']); em.call_iat('SendMessageW')
em.mov_r64_ripmem('rcx',bsyms['hwnd_preview']); em.mov_r32_imm('rdx',0x00B7); em.xor32('r8'); em.xor32('r9'); em.call_iat('SendMessageW')
...
em.mov_ripmem_imm32(bsyms['content_x'],229)
em.mov_r32_ripmem('r10',bsyms['client_w']); em.sub_r32_imm8('r10',100); em.sub_r32_imm8('r10',100); em.sub_r32_imm8('r10',29); em.mov_ripmem_r32(bsyms['content_w'],'r10')
...
em.xor32('rdx'); em.xor32('r8'); em.mov_r32_imm('r9',228); em.mov_mrsp_reg32(0x20,'r11'); em.mov_mrsp_imm32(0x28,1,qword=True); em.call_iat('MoveWindow')
em.label('resize_doc')
# Source edit surface.
...
# WM_SETFONT can restore EDIT's default text margins; set our 20px gutter after the font change.
em.mov_r64_ripmem('rcx',bsyms['hwnd_edit']); em.mov_r32_imm('rdx',0x00D3); em.mov_r32_imm('r8',3); em.mov_r32_imm('r9',0x00140014); em.call_iat('SendMessageW')
...
# Put a newly opened document at its true beginning before the one final paint.
...
em.mov_r64_ripmem('rcx',bsyms['hwnd_edit']); em.xor32('rdx'); em.mov_r32_imm('r8',1); em.call_iat('InvalidateRect')
...
em.label('theme_del_outline'); em.mov_r64_ripmem('rcx',bsyms['hbrush_outline']); em.test64('rcx'); em.jcc(0x84,'theme_del_status'); em.call_iat('DeleteObject')
...
em.mov_r32_imm('rcx',0x001A1A1A); em.call_iat('CreateSolidBrush'); em.mov_ripmem_r64(bsyms['hbrush_edit'],'rax'); em.mov_r32_imm('rcx',0x001F1F1F); em.call_iat('CreateSolidBrush'); em.mov_ripmem_r64(bsyms['hbrush_outline'],'rax'); em.mov_r32_imm('rcx',0x00202020); em.call_iat('CreateSolidBrush'); em.mov_ripmem_r64(bsyms['hbrush_status'],'rax'); em.mov_r32_imm('rcx',0x00202020); em.call_iat('CreateSolidBrush'); em.mov_ripmem_r64(bsyms['hbrush_menu'],'rax'); em.jmp('theme_controls')
em.label('theme_make_light'); em.mov_r32_imm('rcx',0x00FFFFFF); em.call_iat('CreateSolidBrush'); em.mov_ripmem_r64(bsyms['hbrush_edit'],'rax'); em.mov_r32_imm('rcx',0x00F3F4F5); em.call_iat('CreateSolidBrush'); em.mov_ripmem_r64(bsyms['hbrush_outline'],'rax'); em.mov_r32_imm('rcx',0x00F5F5F5); em.call_iat('CreateSolidBrush'); em.mov_ripmem_r64(bsyms['hbrush_status'],'rax'); em.mov_r32_imm('rcx',0x00F5F5F5); em.call_iat('CreateSolidBrush'); em.mov_ripmem_r64(bsyms['hbrush_menu'],'rax')
...
# The only STATIC child is the lower-right status-corner cover.
em.mov_r64_ripmem('rax',bsyms['hbrush_status']); em.add_r64_imm8('rsp',0x38); em.emit(0xC3)
...
out = '/mnt/data/direct_pe_markdown_editor_x64_v8_4_7.exe'
