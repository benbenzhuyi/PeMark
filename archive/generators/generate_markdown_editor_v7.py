...
wstr('title','Direct PE Markdown Editor x64 V7 — No Compiler')
wstr('empty','')
wstr('menu_file','&File')
wstr('menu_edit','&Edit')
...
wstr('m_preview','Markdown &Preview (Basic)\tCtrl+Shift+V')
...
# View -> Zoom, Word Wrap, Status Bar, Markdown Preview
...
append_imm('r14',0x8,1304,'m_wrap'); append_imm('r14',0x8,1305,'m_status'); append_imm('r14',0,1306,'m_preview')
...
# Hidden read-only preview pane; shown by View -> Markdown Preview.
em.xor32('rcx'); em.lea_rip('rdx',rsyms['class_edit']); em.lea_rip('r8',rsyms['empty']); em.mov_r32_imm('r9',0x40A11844)
...
for cid,label in [(1001,'cmd_new'),(1002,'cmd_open'),(1003,'cmd_save'),(1004,'cmd_saveas'),(1005,'cmd_exit'),
                  ...
                  (1301,'cmd_zoomin'),(1302,'cmd_zoomout'),(1303,'cmd_zoomreset'),(1304,'cmd_wrap'),(1305,'cmd_status'),(1306,'cmd_preview'),
...
em.mov_r64_r64('rcx','rsi'); em.call_iat('SetFocus'); em.call_label('resize_children'); em.call_label('update_preview'); em.call_label('update_status'); em.jmp('msg_loop')
...
em.call_label('update_preview'); em.call_label('resize_children'); em.mov_r64_ripmem('rcx',bsyms['hwnd_edit']); em.call_iat('SetFocus'); em.jmp('msg_loop')
...
em.lea_rip('rcx',bsyms['msg']); em.call_iat('TranslateMessage'); em.lea_rip('rcx',bsyms['msg']); em.call_iat('DispatchMessageW'); em.call_label('update_preview'); em.call_label('update_status'); em.mov_r64_r64('rcx','rbx'); em.call_iat('IsWindow'); em.test32('rax'); em.jcc(0x85,'msg_loop')
...
em.mov_r32_ripmem('rax',bsyms['preview_flag']); em.test32('rax'); em.jcc(0x84,'resize_single')
# Split client width approximately 50/50 when preview is visible.
em.mov_r32_r32('rax','r10'); em.shr_r32_imm8('rax',1)
em.mov_r64_ripmem('rcx',bsyms['hwnd_edit']); em.test64('rcx'); em.jcc(0x84,'resize_preview_only')
em.xor32('rdx'); em.xor32('r8'); em.mov_r32_r32('r9','rax'); em.mov_mrsp_reg32(0x20,'r11'); em.mov_mrsp_imm32(0x28,1,qword=True); em.call_iat('MoveWindow')
em.label('resize_preview_only')
# Reload dimensions because MoveWindow may clobber volatile registers.
em.mov_r32_ripmem('r10',bsyms['client_w']); em.mov_r32_ripmem('r11',bsyms['client_h']); em.mov_r32_ripmem('rax',bsyms['status_h']); em.sub_r32_r32('r11','rax')
em.mov_r32_r32('rax','r10'); em.shr_r32_imm8('rax',1)
em.mov_r64_ripmem('rcx',bsyms['hwnd_preview']); em.test64('rcx'); em.jcc(0x84,'resize_ret')
em.mov_r32_r32('rdx','rax'); em.xor32('r8'); em.mov_r32_r32('r9','r10'); em.sub_r32_r32('r9','rax'); em.mov_mrsp_reg32(0x20,'r11'); em.mov_mrsp_imm32(0x28,1,qword=True); em.call_iat('MoveWindow'); em.jmp('resize_ret')
em.label('resize_single')
...
em.label('font_preview'); em.mov_r64_ripmem('rcx',bsyms['hwnd_preview']); em.test64('rcx'); em.jcc(0x84,'font_delete_old'); em.mov_r32_imm('rdx',0x0030); em.mov_r64_ripmem('r8',bsyms['hfont']); em.mov_r32_imm('r9',1); em.call_iat('SendMessageW')
...
# Helper: lightweight Markdown preview. It strips common inline markers and line prefixes,
# converts '- ' at line start to a bullet, and hides link destinations while preserving link text.
em.label('update_preview')
em.emit(0x56); em.emit(0x57); em.emit(0x41,0x55)  # push rsi,rdi,r13
em.emit(0x48,0x83,0xEC,0x20)
em.mov_r32_ripmem('rax',bsyms['preview_flag']); em.test32('rax'); em.jcc(0x84,'preview_ret')
em.mov_r64_ripmem('rax',bsyms['hwnd_preview']); em.test64('rax'); em.jcc(0x84,'preview_ret')
...
em.lea_rip('rsi',bsyms['widebuf']); em.lea_rip('rdi',bsyms['previewbuf']); em.xor32('r10'); em.xor32('r11'); em.mov_r32_imm('r8',1)
em.label('pv_loop')
em.movzx_r32_word_index2('rax','rsi','r10'); em.test32('rax'); em.jcc(0x84,'pv_done')
# line-start handling
em.test32('r8'); em.jcc(0x84,'pv_inline')
em.cmp_r32_imm('rax',0x23); em.jcc(0x84,'pv_hashes')      # # heading markers
em.cmp_r32_imm('rax',0x3E); em.jcc(0x84,'pv_quote')       # > quote
em.cmp_r32_imm('rax',0x2D); em.jcc(0x84,'pv_dash')        # - bullet
em.xor32('r8'); em.jmp('pv_inline')
em.label('pv_hashes')
em.label('pv_hash_loop'); em.add_r32_imm8('r10',1); em.movzx_r32_word_index2('rax','rsi','r10'); em.cmp_r32_imm('rax',0x23); em.jcc(0x84,'pv_hash_loop'); em.cmp_r32_imm('rax',0x20); em.jcc(0x85,'pv_hash_ready'); em.add_r32_imm8('r10',1)
em.label('pv_hash_ready'); em.xor32('r8'); em.jmp('pv_loop')
em.label('pv_quote')
em.mov_r32_r32('r13','r10'); em.add_r32_imm8('r13',1); em.movzx_r32_word_index2('rax','rsi','r13'); em.cmp_r32_imm('rax',0x20); em.jcc(0x85,'pv_inline_reset'); em.add_r32_imm8('r10',2); em.xor32('r8'); em.jmp('pv_loop')
em.label('pv_dash')
em.mov_r32_r32('r13','r10'); em.add_r32_imm8('r13',1); em.movzx_r32_word_index2('rax','rsi','r13'); em.cmp_r32_imm('rax',0x20); em.jcc(0x85,'pv_inline_reset'); em.mov_word_index2_imm16('rdi','r11',0x2022); em.add_r32_imm8('r11',1); em.mov_word_index2_imm16('rdi','r11',0x20); em.add_r32_imm8('r11',1); em.add_r32_imm8('r10',2); em.xor32('r8'); em.jmp('pv_loop')
em.label('pv_inline_reset'); em.xor32('r8'); em.movzx_r32_word_index2('rax','rsi','r10')
em.label('pv_inline')
# newline: copy and mark next line start only on LF
em.cmp_r32_imm('rax',0x0A); em.jcc(0x84,'pv_lf')
# strip emphasis/code markers
em.cmp_r32_imm('rax',0x2A); em.jcc(0x84,'pv_skipone')
em.cmp_r32_imm('rax',0x60); em.jcc(0x84,'pv_skipone')
em.cmp_r32_imm('rax',0x5F); em.jcc(0x84,'pv_skipone')
# opening [ is omitted; ](url) hides destination
em.cmp_r32_imm('rax',0x5B); em.jcc(0x84,'pv_skipone')
em.cmp_r32_imm('rax',0x5D); em.jcc(0x84,'pv_closebracket')
em.label('pv_copy'); em.mov_word_index2_reg('rdi','r11','rax'); em.add_r32_imm8('r11',1); em.add_r32_imm8('r10',1); em.jmp('pv_loop')
em.label('pv_lf'); em.mov_word_index2_reg('rdi','r11','rax'); em.add_r32_imm8('r11',1); em.add_r32_imm8('r10',1); em.mov_r32_imm('r8',1); em.jmp('pv_loop')
em.label('pv_skipone'); em.add_r32_imm8('r10',1); em.jmp('pv_loop')
em.label('pv_closebracket')
em.mov_r32_r32('r13','r10'); em.add_r32_imm8('r13',1); em.movzx_r32_word_index2('rax','rsi','r13'); em.cmp_r32_imm('rax',0x28); em.jcc(0x85,'pv_skipone')
# Skip ]( ... ) completely, leaving link text already copied.
em.add_r32_imm8('r10',2)
em.label('pv_url_loop'); em.movzx_r32_word_index2('rax','rsi','r10'); em.test32('rax'); em.jcc(0x84,'pv_done'); em.cmp_r32_imm('rax',0x29); em.jcc(0x84,'pv_url_done'); em.add_r32_imm8('r10',1); em.jmp('pv_url_loop')
em.label('pv_url_done'); em.add_r32_imm8('r10',1); em.jmp('pv_loop')
em.label('pv_done'); em.mov_word_index2_zero('rdi','r11'); em.mov_r64_ripmem('rcx',bsyms['hwnd_preview']); em.lea_rip('rdx',bsyms['previewbuf']); em.call_iat('SetWindowTextW')
em.label('preview_ret'); em.add_r64_imm8('rsp',0x20); em.emit(0x41,0x5D); em.emit(0x5F); em.emit(0x5E); em.emit(0xC3)
...
# ---------------- PE writer ----------------
# ---------------- PE writer (v7: one loader-simple section) ----------------
...
out = '/mnt/data/direct_pe_markdown_editor_x64_v7.exe'
