...
wstr('title','Direct PE Markdown Editor x64 V8.2 — No Compiler')
wstr('empty','')
wstr('menu_file','&File')
wstr('menu_edit','&Edit')
...
em.jmp('style_next')
em.label('style_bold'); em.mov_mreg_imm32('r11',4,0x20000001); em.mov_mreg_imm32('r11',8,1); em.lea_rip('rcx',bsyms['charfmt']+26); em.lea_rip('rdx',rsyms['font_face']); em.call_iat('lstrcpyW'); em.jmp('style_send')
em.label('style_italic'); em.mov_mreg_imm32('r11',4,0x20000002); em.mov_mreg_imm32('r11',8,2); em.lea_rip('rcx',bsyms['charfmt']+26); em.lea_rip('rdx',rsyms['font_face']); em.call_iat('lstrcpyW'); em.jmp('style_send')
...
out = '/mnt/data/direct_pe_markdown_editor_x64_v8_2.exe'
