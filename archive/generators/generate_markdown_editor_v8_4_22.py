...
FILE_ALIGN = 0x200
SECT_ALIGN = 0x1000
STYLE_CAP = 131072  # V8.4.22: large-doc Markdown style span capacity
...
wstr('title','Direct PE Markdown Editor x64 V8.4.22 — No Compiler')
wstr('empty','')
wstr('menu_file','&File')
wstr('menu_edit','&Edit')
...
bss_alloc('outline_scroll_drag', 4, 4)
bss_alloc('outline_scroll_drag_offset', 4, 4)
bss_alloc('outline_scroll_thumb_top', 4, 4)
bss_alloc('outline_scroll_thumb_h', 4, 4)
bss_alloc('outline_scroll_track_h', 4, 4)
bss_alloc('outline_visible_rows', 4, 4)
bss_alloc('outline_max_top', 4, 4)
...
em.mov_ripmem_imm32(bsyms['outline_scroll_thumb_h'],24)
...
# V8.4.22: reserve a permanent scrollbar gutter whose width follows the current
...
# V8.4.22: register a dedicated scrollbar-surface child class.  Unlike an
...
# Left Markdown outline. V8.4.22 intentionally omits WS_VSCROLL: the ListBox
...
# V8.4.22 architecture preview: dedicated custom scrollbar surface.
...
em.xor32('rcx'); em.lea_rip('rdx',rsyms['class_scroll_surface']); em.lea_rip('r8',rsyms['empty']); em.mov_r32_imm('r9',0x54000000)  # WS_CHILD|VISIBLE|CLIPSIBLINGS
em.mov_mrsp_imm32(0x20,210); em.mov_mrsp_imm32(0x28,0); em.mov_mrsp_imm32(0x30,18); em.mov_mrsp_imm32(0x38,590)
...
# Reveal scrollbar immediately and refresh geometry.
em.mov_ripmem_imm32(bsyms['outline_scroll_visible'],1); em.call_label('sync_outline_scrollbar')
# Hit-test thumb [thumb_top, thumb_top+thumb_h].
em.mov_r32_ripmem('r10',bsyms['cursor_pt']+4); em.mov_r32_ripmem('r11',bsyms['outline_scroll_thumb_top']); em.cmp_r32_r32('r10','r11'); em.jcc(0x8C,'lbd_scroll_pageup')
em.mov_r32_ripmem('rax',bsyms['outline_scroll_thumb_h']); em.add_r32_r32('r11','rax'); em.cmp_r32_r32('r10','r11'); em.jcc(0x8D,'lbd_scroll_pagedown')
...
em.mov_r64_ripmem('rcx',bsyms['hwnd_outline']); em.mov_r32_imm('rdx',0x018E); em.xor32('r8'); em.xor32('r9'); em.call_iat('SendMessageW'); em.mov_ripmem_r32(bsyms['outline_scroll_top'],'rax')
# visibleRows ~= content_h / 30 (row height), minimum 1.
em.mov_r32_ripmem('rcx',bsyms['content_h']); em.mov_r32_imm('rdx',1); em.mov_r32_imm('r8',30); em.call_iat('MulDiv'); em.test32('rax'); em.jcc(0x85,'sync_rows_ok'); em.mov_r32_imm('rax',1)
...
em.mov_r32_ripmem('r10',bsyms['content_h']); em.cmp_r32_imm('r10',8); em.jcc(0x87,'sync_track_ok'); em.mov_r32_imm('r10',8)
...
em.mov_r32_ripmem('r11',bsyms['outline_scroll_count']); em.test32('r11'); em.jcc(0x84,'sync_thumb_full'); em.mov_r32_ripmem('rax',bsyms['outline_visible_rows']); em.cmp_r32_r32('rax','r11'); em.jcc(0x83,'sync_thumb_calc')
em.label('sync_thumb_full'); em.mov_r32_ripmem('rax',bsyms['outline_scroll_track_h']); em.jmp('sync_thumb_store')
em.label('sync_thumb_calc'); em.mov_r32_ripmem('rcx',bsyms['outline_visible_rows']); em.mov_r32_ripmem('rdx',bsyms['outline_scroll_track_h']); em.mov_r32_ripmem('r8',bsyms['outline_scroll_count']); em.call_iat('MulDiv'); em.cmp_r32_imm('rax',24); em.jcc(0x83,'sync_thumb_store'); em.mov_r32_imm('rax',24)
...
# Repaint only the overlay surface, synchronously.  A queued WM_PAINT could be
# starved by a stream of mouse messages and left the old theme/gutter visible.
...
em.mov_r32_ripmem('rax',bsyms['outline_scroll_visible']); em.test32('rax'); em.jcc(0x85,'hover_cursor_custom'); em.mov_ripmem_imm32(bsyms['outline_scroll_visible'],1); em.call_label('sync_outline_scrollbar'); em.jmp('hover_cursor_custom')
em.label('hover_hide_custom')
em.mov_r32_ripmem('rax',bsyms['outline_scroll_visible']); em.test32('rax'); em.jcc(0x84,'hover_cursor_custom'); em.mov_ripmem_imm32(bsyms['outline_scroll_visible'],0); em.mov_r64_ripmem('rcx',bsyms['hwnd_outline_scroll']); em.xor32('rdx'); em.xor32('r8'); em.mov_r32_imm('r9',0x105); em.call_iat('RedrawWindow')
...
em.emit(0x48,0x83,0xEC,0x38)
em.lea_rip('rcx',bsyms['cursor_pt']); em.call_iat('GetCursorPos'); em.test32('rax'); em.jcc(0x84,'os_drag_ret')
em.mov_r64_ripmem('rcx',bsyms['hwnd_main']); em.lea_rip('rdx',bsyms['cursor_pt']); em.call_iat('ScreenToClient'); em.test32('rax'); em.jcc(0x84,'os_drag_ret')
# desired thumb offset inside track = y - dragOffset - 4, clamped to [0, travel].
em.mov_r32_ripmem('r10',bsyms['cursor_pt']+4); em.mov_r32_ripmem('rax',bsyms['outline_scroll_drag_offset']); em.sub_r32_r32('r10','rax'); em.cmp_r32_imm('r10',4); em.jcc(0x83,'os_drag_after_top'); em.mov_r32_imm('r10',4)
em.label('os_drag_after_top'); em.sub_r32_imm8('r10',4)
em.mov_r32_ripmem('r11',bsyms['outline_scroll_track_h']); em.mov_r32_ripmem('rax',bsyms['outline_scroll_thumb_h']); em.sub_r32_r32('r11','rax'); em.cmp_r32_r32('r10','r11'); em.jcc(0x86,'os_drag_pos_ok'); em.mov_r32_r32('r10','r11')
em.label('os_drag_pos_ok'); em.mov_r32_ripmem('r11',bsyms['outline_max_top']); em.test32('r11'); em.jcc(0x84,'os_drag_zero')
em.mov_r32_r32('rcx','r10'); em.mov_r32_r32('rdx','r11'); em.mov_r32_ripmem('r8',bsyms['outline_scroll_track_h']); em.mov_r32_ripmem('rax',bsyms['outline_scroll_thumb_h']); em.sub_r32_r32('r8','rax'); em.test32('r8'); em.jcc(0x84,'os_drag_zero'); em.call_iat('MulDiv'); em.mov_r32_r32('r10','rax'); em.jmp('os_drag_apply')
...
em.mov_r64_ripmem('rcx',bsyms['hwnd_outline_gutter']); em.mov_r32_imm('rdx',5); em.call_iat('ShowWindow')
em.mov_r64_ripmem('rcx',bsyms['hwnd_splitter']); em.mov_r32_imm('rdx',5); em.call_iat('ShowWindow')
# Custom overlay surface is permanently present in its gutter; hover controls drawing only.
...
# Preview navigation derives its target from the canonical source heading offset.
# outline_renderpos can be temporarily stale/zero during first large-file load; the
# current render_srcmap is authoritative once Preview exists.
em.lea_rip('rcx',bsyms['outline_srcpos']); em.add_r64_r64('rcx','rax'); em.mov_r32_ptr('r8','rcx'); em.call_label('map_source_to_render'); em.mov_r32_r32('r8','rax'); em.mov_r32_r32('r9','rax'); em.mov_r64_ripmem('rcx',bsyms['hwnd_preview']); em.mov_ripmem_r64(bsyms['nav_hwnd'],'rcx'); em.jmp('navigate_send')
...
em.mov_r32_ripmem('rax',bsyms['preview_flag']); em.test32('rax'); em.jcc(0x84,'navigate_ret'); em.call_label('refresh_preview_visible_theme')
...
# Visual thumb width = clamp(clientWidth/3, 5..8), centered in the permanent gutter.
...
em.label('sp_width_have'); em.mov_r32_r32('rcx','rax'); em.mov_r32_imm('rdx',1); em.mov_r32_imm('r8',3); em.call_iat('MulDiv')
em.cmp_r32_imm('rax',5); em.jcc(0x83,'sp_w_min_ok'); em.mov_r32_imm('rax',5)
em.label('sp_w_min_ok'); em.cmp_r32_imm('rax',8); em.jcc(0x86,'sp_w_ok'); em.mov_r32_imm('rax',8)
...
# Thumb visual width = clamp(scrollbar_w/3, 5..8), centered in gutter.
em.mov_r32_ripmem('rcx',bsyms['scrollbar_w']); em.mov_r32_imm('rdx',1); em.mov_r32_imm('r8',3); em.call_iat('MulDiv'); em.cmp_r32_imm('rax',5); em.jcc(0x83,'wp_scroll_w_min_ok'); em.mov_r32_imm('rax',5)
em.label('wp_scroll_w_min_ok'); em.cmp_r32_imm('rax',8); em.jcc(0x86,'wp_scroll_w_ok'); em.mov_r32_imm('rax',8)
em.label('wp_scroll_w_ok'); em.mov_r32_r32('r10','rax')
# Build thumb RECT in draw_rect: left=(gutterW-thumbW)/2, right=left+thumbW.
em.lea_rip('rcx',bsyms['draw_rect']); em.mov_r32_ripmem('rax',bsyms['scrollbar_w']); em.sub_r32_r32('rax','r10'); em.shr_r32_imm8('rax',1); em.mov_ptr_r32('rcx','rax'); em.mov_r32_ripmem('r11',bsyms['outline_scroll_thumb_top']); em.mov_mreg_reg32('rcx',4,'r11'); em.add_r32_r32('rax','r10'); em.mov_mreg_reg32('rcx',8,'rax'); em.mov_r32_ripmem('rax',bsyms['outline_scroll_thumb_h']); em.add_r32_r32('r11','rax'); em.mov_mreg_reg32('rcx',12,'r11')
...
# V8.4.22: hard-isolate owner-drawn Outline rows from the native scrollbar gutter.
...
out = '/mnt/data/direct_pe_markdown_editor_x64_v8_4_22.exe'
