...
wstr('title','Direct PE Markdown Editor x64 V8.1 — No Compiler')
wstr('empty','')
wstr('menu_file','&File')
wstr('menu_edit','&Edit')
...
imports = {
    ...
    'USER32.dll': [
        ...
        'CreateAcceleratorTableW','TranslateAcceleratorW','DestroyAcceleratorTable','IsDialogMessageW','SetForegroundWindow','DrawMenuBar','DrawTextW','FillRect'
    ],
    'COMDLG32.dll': ['GetOpenFileNameW','GetSaveFileNameW','FindTextW','ReplaceTextW'],
    'SHLWAPI.dll': ['StrStrW','StrStrIW'],
    'COMCTL32.dll': ['InitCommonControlsEx'],
    'GDI32.dll': ['CreateFontW','DeleteObject','CreateSolidBrush','SetTextColor','SetBkColor','SetBkMode'],
...
em.mov_r32_r32('r11','rax'); em.add_r32_r32('rax','rax'); em.add_r32_r32('rax','rax'); em.lea_rip('rcx',bsyms['outline_srcpos']); em.add_r64_r64('rcx','rax'); em.mov_ptr_r32('rcx','r12'); em.lea_rip('rcx',bsyms['outline_renderpos']); em.add_r64_r64('rcx','rax'); em.xor32('r15'); em.mov_ptr_r32('rcx','r15')
...
em.cmp_r32_imm('rdx',0x002B); em.jcc(0x84,'wp_drawitem')     # WM_DRAWITEM (owner-drawn status parts)
...
# Owner-draw the status-bar text so Dark Mode always uses a light foreground.
em.label('wp_drawitem')
em.mov_ripmem_r64(bsyms['drawitem_ptr'],'r9')
em.mov_r32_mreg('rax','r9',4); em.cmp_r32_imm('rax',2); em.jcc(0x85,'wp_default')
# Fill the item interior using the same surface brush as the side panel.
...
# Foreground color follows the current theme.
...
# Draw itemData (the status string pointer) vertically centered, with '&' treated literally.
...
out = '/mnt/data/direct_pe_markdown_editor_x64_v8_1.exe'
