...
FILE_ALIGN = 0x200
SECT_ALIGN = 0x1000
STYLE_CAP = 131072  # V8.4.21: large-doc Markdown style span capacity
...
wstr('title','Direct PE Markdown Editor x64 V8.4.21 — No Compiler')
wstr('empty','')
wstr('menu_file','&File')
wstr('menu_edit','&Edit')
...
# V8.4.21: reserve a permanent scrollbar gutter whose width follows the current
...
# V8.4.21: register a dedicated scrollbar-surface child class.  Unlike an
...
# Left Markdown outline. V8.4.21 intentionally omits WS_VSCROLL: the ListBox
...
# V8.4.21 architecture preview: dedicated custom scrollbar surface.
...
em.mov_ripmem_imm32(bsyms['outline_scroll_visible'],0); em.mov_r64_ripmem('rcx',bsyms['hwnd_outline_scroll']); em.xor32('rdx'); em.mov_r32_imm('r8',1); em.call_iat('InvalidateRect')
em.call_label('splitter_drag_move'); em.jmp('msg_loop')
...
# Repaint only the overlay surface.
em.mov_r64_ripmem('rcx',bsyms['hwnd_outline_scroll']); em.xor32('rdx'); em.mov_r32_imm('r8',1); em.call_iat('InvalidateRect')
...
em.mov_r32_ripmem('rax',bsyms['outline_scroll_visible']); em.test32('rax'); em.jcc(0x84,'hover_cursor_custom'); em.mov_ripmem_imm32(bsyms['outline_scroll_visible'],0); em.mov_r64_ripmem('rcx',bsyms['hwnd_outline_scroll']); em.xor32('rdx'); em.mov_r32_imm('r8',1); em.call_iat('InvalidateRect')
...
# Build thumb rectangle in draw_rect using current scrollbar model geometry.
em.mov_r64_ripmem('rcx',bsyms['scroll_paint_hwnd']); em.lea_rip('rdx',bsyms['draw_rect']); em.call_iat('GetClientRect')
...
# V8.4.21: hard-isolate owner-drawn Outline rows from the native scrollbar gutter.
...
out = '/mnt/data/direct_pe_markdown_editor_x64_v8_4_21.exe'
