...
FILE_ALIGN = 0x200
SECT_ALIGN = 0x1000
STYLE_CAP = 131072  # V8.4.20: large-doc Markdown style span capacity
...
wstr('title','Direct PE Markdown Editor x64 V8.4.20 — No Compiler')
wstr('empty','')
wstr('menu_file','&File')
wstr('menu_edit','&Edit')
...
imports = {
    ...
    'USER32.dll': [
        ...
        'GetCursorPos','ScreenToClient','SetCapture','ReleaseCapture','SetCursor','SetScrollRange','SetScrollPos','ShowScrollBar','GetKeyState','GetSystemMetrics','SetTimer','KillTimer',
...
# V8.4.20: reserve a permanent scrollbar gutter whose width follows the current
...
# Left Markdown outline. V8.4.20 intentionally omits WS_VSCROLL: the ListBox
...
# V8.4.20 architecture preview: owner-drawn overlay scrollbar surface.
# It is a permanent STATIC in the fixed gutter, not a Win32 SCROLLBAR.  The ListBox
# geometry therefore never changes and Light/Dark styling is entirely palette-driven.
em.xor32('rcx'); em.lea_rip('rdx',rsyms['class_static']); em.lea_rip('r8',rsyms['empty']); em.mov_r32_imm('r9',0x5400010D)  # WS_CHILD|VISIBLE|CLIPSIBLINGS|SS_NOTIFY|SS_OWNERDRAW
em.mov_mrsp_imm32(0x20,210); em.mov_mrsp_imm32(0x28,0); em.mov_mrsp_imm32(0x30,18); em.mov_mrsp_imm32(0x38,590)
...
em.mov_r32_mreg('rax','r9',4); em.cmp_r32_imm('rax',2); em.jcc(0x84,'wp_draw_status'); em.cmp_r32_imm('rax',4); em.jcc(0x84,'wp_draw_outline'); em.cmp_r32_imm('rax',5); em.jcc(0x84,'wp_draw_corner'); em.cmp_r32_imm('rax',6); em.jcc(0x84,'wp_draw_splitter'); em.cmp_r32_imm('rax',7); em.jcc(0x84,'wp_draw_gutter'); em.cmp_r32_imm('rax',8); em.jcc(0x84,'wp_draw_scrollbar'); em.jmp('wp_default')
...
# V8.4.20: hard-isolate owner-drawn Outline rows from the native scrollbar gutter.
...
out = '/mnt/data/direct_pe_markdown_editor_x64_v8_4_20.exe'
