...
wstr('title','Direct PE Markdown Editor x64 V8.4.2 — No Compiler')
wstr('empty','')
wstr('menu_file','&File')
wstr('menu_edit','&Edit')
...
# V8.4.2: robust large-document capacities. A 4 MiB ASCII LF-only file can
...
imports = {
    ...
    'USER32.dll': [
        ...
        'CreateAcceleratorTableW','TranslateAcceleratorW','DestroyAcceleratorTable','IsDialogMessageW','SetForegroundWindow','DrawMenuBar','DrawTextW','FillRect','GetMenuStringW','SetMenuInfo'
    ],
...
em.xor32('rcx'); em.lea_rip('rdx',rsyms['class_static']); em.lea_rip('r8',rsyms['empty']); em.mov_r32_imm('r9',0x50000000)
em.mov_mrsp_imm32(0x20,0); em.mov_mrsp_imm32(0x28,0); em.mov_mrsp_imm32(0x30,20); em.mov_mrsp_imm32(0x38,20)
...
em.mov_r32_ripmem('rdx',bsyms['client_w']); em.sub_r32_imm8('rdx',20)
em.mov_r32_ripmem('r8',bsyms['client_h']); em.mov_r32_ripmem('rax',bsyms['status_h']); em.sub_r32_r32('r8','rax')
em.mov_r32_imm('r9',20); em.mov_r32_ripmem('r11',bsyms['status_h']); em.mov_mrsp_reg32(0x20,'r11'); em.mov_mrsp_imm32(0x28,1,qword=True); em.call_iat('MoveWindow')
...
em.call_iat('DefWindowProcW'); em.mov_ripmem_r64(bsyms['defproc_result'],'rax')
...
em.mov_r64_mreg('rcx','r9',32); em.mov_r64_r64('rdx','r9'); em.add_r64_imm8('rdx',40); em.mov_r64_ripmem('r8',bsyms['hbrush_status']); em.call_iat('FillRect')
...
out = '/mnt/data/direct_pe_markdown_editor_x64_v8_4_2.exe'
