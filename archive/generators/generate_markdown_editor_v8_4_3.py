...
wstr('title','Direct PE Markdown Editor x64 V8.4.3 — No Compiler')
wstr('empty','')
wstr('menu_file','&File')
wstr('menu_edit','&Edit')
...
# V8.4.3: robust large-document capacities. The previous build also had a
...
em.mov_mrsp_imm32(0x20,0); em.mov_mrsp_imm32(0x28,0); em.mov_mrsp_imm32(0x30,32); em.mov_mrsp_imm32(0x38,24)
...
em.mov_r32_ripmem('rdx',bsyms['client_w']); em.sub_r32_imm8('rdx',32)
em.mov_r32_ripmem('r8',bsyms['client_h']); em.mov_r32_ripmem('rax',bsyms['status_h']); em.sub_r32_r32('r8','rax')
em.mov_r32_imm('r9',32); em.mov_r32_ripmem('r11',bsyms['status_h']); em.mov_mrsp_reg32(0x20,'r11'); em.mov_mrsp_imm32(0x28,1,qword=True); em.call_iat('MoveWindow')
...
out = '/mnt/data/direct_pe_markdown_editor_x64_v8_4_3.exe'
