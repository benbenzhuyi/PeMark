...
wstr('title','Direct PE Markdown Editor x64 V8.4.10 — No Compiler')
wstr('empty','')
wstr('menu_file','&File')
wstr('menu_edit','&Edit')
...
imports = {
    ...
    'USER32.dll': [
        ...
        'GetCursorPos','ScreenToClient','SetCapture','ReleaseCapture','SetCursor','SetScrollRange','SetScrollPos','ShowScrollBar',
...
em.mov_mrsp_imm32(0x20,228); em.mov_mrsp_imm32(0x28,0); em.mov_mrsp_imm32(0x30,4); em.mov_mrsp_imm32(0x38,590)
...
# V8.4.10: no separate floating SCROLLBAR child. The Outline's native themed
# scrollbar is shown/hidden dynamically with ShowScrollBar, so the thumb has the
# same Windows style and full drag behavior as the document scrollbars.
...
em.mov_eax_mr12(8); em.cmp_r32_imm('rax',0x0115); em.jcc(0x84,'dispatch_theme_refresh'); em.cmp_r32_imm('rax',0x020A); em.jcc(0x85,'dispatch_theme_refresh_done')
...
# is near the divider. Because this is the ListBox scrollbar itself, the thumb is
# complete, clickable and draggable just like the main Edit/RichEdit scrollbar.
...
# Hover zone: roughly the rightmost 20px of Outline plus the 5px splitter.
...
# Size-WE cursor only on the splitter itself; the native scrollbar keeps its own arrow/thumb behavior.
em.lea_rip('rcx',bsyms['cursor_pt']); em.call_iat('GetCursorPos'); em.mov_r64_ripmem('rcx',bsyms['hwnd_splitter']); em.lea_rip('rdx',bsyms['cursor_pt']); em.call_iat('ScreenToClient'); em.mov_r32_ripmem('r10',bsyms['cursor_pt']); em.test32('r10'); em.jcc(0x88,'hover_done'); em.cmp_r32_imm('r10',4); em.jcc(0x83,'hover_done'); em.xor32('rcx'); em.mov_r32_imm('rdx',32644); em.call_iat('LoadCursorW'); em.mov_r64_r64('rcx','rax'); em.call_iat('SetCursor'); em.jmp('hover_done')
em.label('hover_hide'); em.mov_r32_ripmem('rax',bsyms['outline_scroll_visible']); em.test32('rax'); em.jcc(0x84,'hover_done'); em.mov_r64_ripmem('rcx',bsyms['hwnd_outline']); em.mov_r32_imm('rdx',1); em.xor32('r8'); em.call_iat('ShowScrollBar'); em.mov_ripmem_imm32(bsyms['outline_scroll_visible'],0)
...
em.mov_r64_ripmem('rcx',bsyms['hwnd_preview']); em.call_label('capture_surface_state'); em.call_label('set_visible_format_window'); em.mov_ripmem_imm32(bsyms['preview_visible_format_only'],1); em.call_label('apply_styles'); em.mov_ripmem_imm32(bsyms['preview_visible_format_only'],0); em.mov_r64_ripmem('rcx',bsyms['hwnd_preview']); em.call_label('restore_surface_state')
...
em.mov_r32_ripmem('r10',bsyms['outline_width']); em.mov_r32_r32('r11','r10'); em.add_r32_imm8('r11',4); em.mov_ripmem_r32(bsyms['content_x'],'r11')
...
em.mov_r32_ripmem('rdx',bsyms['outline_width']); em.xor32('r8'); em.mov_r32_imm('r9',4); em.mov_mrsp_reg32(0x20,'r11'); em.mov_mrsp_imm32(0x28,1,qword=True); em.call_iat('MoveWindow')
...
out = '/mnt/data/direct_pe_markdown_editor_x64_v8_4_10.exe'
