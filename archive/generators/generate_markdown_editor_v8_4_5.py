...
wstr('title','Direct PE Markdown Editor x64 V8.4.5 — No Compiler')
wstr('empty','')
wstr('menu_file','&File')
wstr('menu_edit','&Edit')
...
# Outline deliberately keeps hfont_outline; zoom affects only source/preview.
...
out = '/mnt/data/direct_pe_markdown_editor_x64_v8_4_5.exe'
