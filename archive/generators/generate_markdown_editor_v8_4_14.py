...
wstr('title','Direct PE Markdown Editor x64 V8.4.14 — No Compiler')
wstr('empty','')
wstr('menu_file','&File')
wstr('menu_edit','&Edit')
...
# V8.4.14 deliberately does not crop or overlay the ListBox non-client scrollbar.
...
# V8.4.14: no scrollbar overlay child. The Outline's own themed ListBox scrollbar
...
# is near the divider. V8.4.14 leaves this non-client scrollbar completely native:
...
out = '/mnt/data/direct_pe_markdown_editor_x64_v8_4_14.exe'
