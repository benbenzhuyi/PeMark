...
wstr('title','Direct PE Markdown Editor x64 V8.4.4 — No Compiler')
wstr('empty','')
wstr('menu_file','&File')
wstr('menu_edit','&Edit')
...
# V8.4.4: robust large-document capacities. The previous build also had a
...
em.xor32('rcx'); em.lea_rip('rdx',rsyms['class_status']); em.lea_rip('r8',rsyms['empty']); em.mov_r32_imm('r9',0x54000000)
...
em.xor32('rcx'); em.lea_rip('rdx',rsyms['class_static']); em.lea_rip('r8',rsyms['empty']); em.mov_r32_imm('r9',0x54000000)
...
# Full-window rendered Markdown mode. First synchronize Source -> Document Model,
# then render from the model. Preview itself never reads or writes Source EDIT.
em.call_label('sync_model_from_editor')
...
em.mov_r32_ripmem('rdx',bsyms['client_w']); em.sub_r32_imm8('rdx',56)
em.mov_r32_ripmem('r8',bsyms['client_h']); em.mov_r32_ripmem('rax',bsyms['status_h']); em.sub_r32_r32('r8','rax')
em.mov_r32_imm('r9',56); em.mov_r32_ripmem('r11',bsyms['status_h']); em.mov_mrsp_reg32(0x20,'r11'); em.mov_mrsp_imm32(0x28,1,qword=True); em.call_iat('MoveWindow')
...
# Document Model -> Source Editor. Suppress EN_CHANGE so loading/recreation does not feed back.
...
em.lea_rip('rdx',bsyms['document_model']); em.call_iat('SetWindowTextW')
...
em.label('outline_rebuild_ret'); em.add_r64_imm8('rsp',0x20); em.emit(0x41,0x5F); em.emit(0x41,0x5E); em.emit(0x41,0x5D); em.emit(0x41,0x5C); em.emit(0x5E); em.emit(0xC3)
...
em.mov_r64_ripmem('rcx',bsyms['paint_hdc']); em.lea_rip('rdx',bsyms['draw_rect']); em.mov_r64_ripmem('r8',bsyms['hbrush_menu']); em.call_iat('FillRect')
# V8.4.4: the remaining white triangle is in the *non-client* sizing corner,
# so a child STATIC can never cover it. Paint the final 18x18 outer-window
# corner on the window DC after DefWindowProc/DWM have drawn the frame.
em.lea_rip('rcx',bsyms['draw_rect'])
em.mov_r32_ripmem('rax',bsyms['nc_winrect']+8); em.mov_r32_ripmem('r10',bsyms['nc_winrect']); em.sub_r32_r32('rax','r10'); em.sub_r32_imm8('rax',18); em.mov_ptr_r32('rcx','rax')
em.mov_r32_ripmem('rax',bsyms['nc_winrect']+12); em.mov_r32_ripmem('r10',bsyms['nc_winrect']+4); em.sub_r32_r32('rax','r10'); em.sub_r32_imm8('rax',18); em.mov_mreg_reg32('rcx',4,'rax')
em.mov_r32_ripmem('rax',bsyms['nc_winrect']+8); em.mov_r32_ripmem('r10',bsyms['nc_winrect']); em.sub_r32_r32('rax','r10'); em.mov_mreg_reg32('rcx',8,'rax')
em.mov_r32_ripmem('rax',bsyms['nc_winrect']+12); em.mov_r32_ripmem('r10',bsyms['nc_winrect']+4); em.sub_r32_r32('rax','r10'); em.mov_mreg_reg32('rcx',12,'rax')
em.mov_r64_ripmem('rcx',bsyms['paint_hdc']); em.lea_rip('rdx',bsyms['draw_rect']); em.mov_r64_ripmem('r8',bsyms['hbrush_status']); em.call_iat('FillRect')
...
em.mov_r32_imm('rcx',0x001E1E1E); em.call_iat('CreateSolidBrush'); em.mov_ripmem_r64(bsyms['hbrush_edit'],'rax'); em.mov_r32_imm('rcx',0x00222222); em.call_iat('CreateSolidBrush'); em.mov_ripmem_r64(bsyms['hbrush_outline'],'rax'); em.mov_r32_imm('rcx',0x00222222); em.call_iat('CreateSolidBrush'); em.mov_ripmem_r64(bsyms['hbrush_status'],'rax'); em.mov_r32_imm('rcx',0x00202020); em.call_iat('CreateSolidBrush'); em.mov_ripmem_r64(bsyms['hbrush_menu'],'rax'); em.jmp('theme_controls')
em.label('theme_make_light'); em.mov_r32_imm('rcx',0x00FFFFFF); em.call_iat('CreateSolidBrush'); em.mov_ripmem_r64(bsyms['hbrush_edit'],'rax'); em.mov_r32_imm('rcx',0x00F5F5F5); em.call_iat('CreateSolidBrush'); em.mov_ripmem_r64(bsyms['hbrush_outline'],'rax'); em.mov_r32_imm('rcx',0x00F3F3F3); em.call_iat('CreateSolidBrush'); em.mov_ripmem_r64(bsyms['hbrush_status'],'rax'); em.mov_r32_imm('rcx',0x00F5F5F5); em.call_iat('CreateSolidBrush'); em.mov_ripmem_r64(bsyms['hbrush_menu'],'rax')
...
em.mov_r64_mreg('rcx','r9',32); em.mov_r64_ripmem('rdx',bsyms['hfont']); em.call_iat('SelectObject'); em.mov_ripmem_r64(bsyms['draw_old_font'],'rax')
...
em.mov_r64_ripmem('r9',bsyms['drawitem_ptr']); em.mov_r64_mreg('rcx','r9',32); em.mov_r64_ripmem('rdx',bsyms['draw_old_font']); em.call_iat('SelectObject')
...
out = '/mnt/data/direct_pe_markdown_editor_x64_v8_4_4.exe'
