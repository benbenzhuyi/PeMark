...
FILE_ALIGN = 0x200
SECT_ALIGN = 0x1000
STYLE_CAP = 131072  # V8.4.19: large-doc Markdown style span capacity
...
wstr('title','Direct PE Markdown Editor x64 V8.4.19 — No Compiler')
wstr('empty','')
wstr('menu_file','&File')
wstr('menu_edit','&Edit')
...
# V8.4.19: reserve a permanent scrollbar gutter whose width follows the current
...
# Left Markdown outline. V8.4.19 intentionally omits WS_VSCROLL: the ListBox
...
# Independent vertical scrollbar. Created once at startup, themed once per theme
# transition, and merely shown/hidden on hover. It never alters ListBox geometry.
em.xor32('rcx'); em.lea_rip('rdx',rsyms['class_scrollbar']); em.lea_rip('r8',rsyms['empty']); em.mov_r32_imm('r9',0x44000001)  # WS_CHILD|WS_CLIPSIBLINGS|SBS_VERT, initially hidden
em.mov_mrsp_imm32(0x20,210); em.mov_mrsp_imm32(0x28,0); em.mov_mrsp_imm32(0x30,18); em.mov_mrsp_imm32(0x38,590)
...
# V8.4.19 resize hit-zone lives only on the document side of the 1px divider:
# [outline_width, outline_width+8]. The scrollbar gutter is entirely to the left,
# so scrollbar dragging and sidebar resizing can never compete for the same pixels.
em.cmp_r32_r32('r10','r11'); em.jcc(0x8C,'dispatch'); em.add_r32_imm8('r11',8); em.cmp_r32_r32('r10','r11'); em.jcc(0x8F,'dispatch')
...
# Helper: reveal the independent Outline scrollbar while the pointer is near the
# permanent gutter. Showing/hiding this child never changes ListBox geometry.
...
# Hover zone starts 8px before the permanent scrollbar gutter and extends 8px
# onto the document side, making the control easy to reveal without changing layout.
em.mov_r32_ripmem('r10',bsyms['cursor_pt']); em.mov_r32_ripmem('r11',bsyms['outline_width'])
em.mov_r32_ripmem('rax',bsyms['scrollbar_w']); em.sub_r32_r32('r11','rax'); em.sub_r32_imm8('r11',8); em.cmp_r32_r32('r10','r11'); em.jcc(0x8C,'hover_hide')
em.mov_r32_ripmem('r11',bsyms['outline_width']); em.add_r32_imm8('r11',8); em.cmp_r32_r32('r10','r11'); em.jcc(0x8F,'hover_hide')
...
# Show the already-created, already-themed child scrollbar. No frame recreation.
...
em.mov_r64_ripmem('rcx',bsyms['hwnd_outline_scroll']); em.mov_r32_imm('rdx',5); em.call_iat('ShowWindow'); em.mov_ripmem_imm32(bsyms['outline_scroll_visible'],1)
# Keep the scrollbar above its gutter but below the logical divider interaction.
...
# Resize cursor only in [outline_width, outline_width+8], entirely outside gutter.
em.mov_r32_ripmem('r10',bsyms['cursor_pt']); em.mov_r32_ripmem('r11',bsyms['outline_width']); em.cmp_r32_r32('r10','r11'); em.jcc(0x8C,'hover_done'); em.add_r32_imm8('r11',8); em.cmp_r32_r32('r10','r11'); em.jcc(0x8F,'hover_done')
...
# Never hide during thumb/track interaction.
em.mov_r32_imm('rcx',1); em.call_iat('GetKeyState'); em.and_r32_imm('rax',0x8000); em.test32('rax'); em.jcc(0x85,'hover_done')
em.mov_r64_ripmem('rcx',bsyms['hwnd_outline_scroll']); em.xor32('rdx'); em.call_iat('ShowWindow'); em.mov_ripmem_imm32(bsyms['outline_scroll_visible'],0)
...
em.mov_r64_ripmem('rcx',bsyms['hwnd_outline_gutter']); em.mov_r32_imm('rdx',5); em.call_iat('ShowWindow')
em.mov_r64_ripmem('rcx',bsyms['hwnd_splitter']); em.mov_r32_imm('rdx',5); em.call_iat('ShowWindow')
em.mov_r32_ripmem('rax',bsyms['outline_scroll_visible']); em.test32('rax'); em.jcc(0x84,'resize_scroll_keep_hidden'); em.mov_r64_ripmem('rcx',bsyms['hwnd_outline_scroll']); em.mov_r32_imm('rdx',5); em.call_iat('ShowWindow'); em.jmp('resize_doc')
em.label('resize_scroll_keep_hidden'); em.mov_r64_ripmem('rcx',bsyms['hwnd_outline_scroll']); em.xor32('rdx'); em.call_iat('ShowWindow'); em.jmp('resize_doc')
...
em.mov_r64_ripmem('rcx',bsyms['hwnd_outline_scroll']); em.mov_r32_imm('rdx',0x031A); em.xor32('r8'); em.xor32('r9'); em.call_iat('SendMessageW')
...
em.cmp_r32_imm('rdx',0x0115); em.jcc(0x84,'wp_vscroll')      # WM_VSCROLL (independent Outline scrollbar)
...
em.mov_r32_mreg('rax','r9',4); em.cmp_r32_imm('rax',2); em.jcc(0x84,'wp_draw_status'); em.cmp_r32_imm('rax',4); em.jcc(0x84,'wp_draw_outline'); em.cmp_r32_imm('rax',5); em.jcc(0x84,'wp_draw_corner'); em.cmp_r32_imm('rax',6); em.jcc(0x84,'wp_draw_splitter'); em.cmp_r32_imm('rax',7); em.jcc(0x84,'wp_draw_gutter'); em.jmp('wp_default')
...
# V8.4.19: hard-isolate owner-drawn Outline rows from the native scrollbar gutter.
...
out = '/mnt/data/direct_pe_markdown_editor_x64_v8_4_19.exe'
