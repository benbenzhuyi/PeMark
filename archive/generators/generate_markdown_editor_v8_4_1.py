...
wstr('title','Direct PE Markdown Editor x64 V8.4.1 — No Compiler')
wstr('empty','')
wstr('menu_file','&File')
wstr('menu_edit','&Edit')
...
out = '/mnt/data/direct_pe_markdown_editor_x64_v8_4_1.exe'
