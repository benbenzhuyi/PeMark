...
wstr('title','Direct PE Markdown Editor x64 V8.4.11 — No Compiler')
wstr('empty','')
wstr('menu_file','&File')
wstr('menu_edit','&Edit')
...
imports = {
    ...
    'USER32.dll': [
        ...
        'GetCursorPos','ScreenToClient','SetCapture','ReleaseCapture','SetCursor','SetScrollRange','SetScrollPos','ShowScrollBar','SetTimer','KillTimer',
...
em.xor32('rcx'); em.lea_rip('rdx',rsyms['class_static']); em.lea_rip('r8',rsyms['empty']); em.mov_r32_imm('r9',0x5000010D)  # SS_OWNERDRAW | SS_NOTIFY
...
# V8.4.11: no separate floating SCROLLBAR child. The Outline's native themed
...
em.mov_r64_ripmem('rcx',bsyms['hwnd_outline']); em.mov_r32_imm('rdx',1); em.mov_r32_imm('r8',1); em.call_iat('ShowScrollBar'); em.mov_ripmem_imm32(bsyms['outline_scroll_visible'],1); em.call_label('repaint_splitter_surface')
...
em.label('hover_hide'); em.mov_r32_ripmem('rax',bsyms['outline_scroll_visible']); em.test32('rax'); em.jcc(0x84,'hover_done'); em.mov_r64_ripmem('rcx',bsyms['hwnd_outline']); em.mov_r32_imm('rdx',1); em.xor32('r8'); em.call_iat('ShowScrollBar'); em.mov_ripmem_imm32(bsyms['outline_scroll_visible'],0); em.call_label('repaint_splitter_surface')
...
em.mov_r64_ripmem('rcx',bsyms['hwnd_splitter']); em.call_iat('UpdateWindow')
em.label('repaint_splitter_ret'); em.add_r64_imm8('rsp',0x28); em.emit(0xC3)
...
out = '/mnt/data/direct_pe_markdown_editor_x64_v8_4_11.exe'
