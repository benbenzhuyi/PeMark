...
FILE_ALIGN = 0x200
SECT_ALIGN = 0x1000
STYLE_CAP = 131072  # V8.4.16: large-doc Markdown style span capacity
...
wstr('title','Direct PE Markdown Editor x64 V8.4.16 — No Compiler')
wstr('empty','')
wstr('menu_file','&File')
wstr('menu_edit','&Edit')
...
# V8.4.16 deliberately does not crop or overlay the ListBox non-client scrollbar.
...
# V8.4.16: no scrollbar overlay child. The Outline's own themed ListBox scrollbar
...
# is near the divider. V8.4.16 leaves this non-client scrollbar completely native:
...
# V8.4.16 suppresses drawing while the non-client scrollbar is being materialized.
...
# V8.4.16: reserve a hard text-safe strip for the native non-client scrollbar.
...
out = '/mnt/data/direct_pe_markdown_editor_x64_v8_4_16.exe'
