...
wstr('title','Direct PE Markdown Editor x64 V8 — No Compiler')
wstr('empty','')
wstr('menu_file','&File')
wstr('menu_edit','&Edit')
...
wstr('m_preview','Markdown &Preview\tCtrl+Shift+V')
wstr('m_outline','&Outline\tCtrl+Shift+O')
wstr('m_light','&Light\tCtrl+Alt+L')
wstr('m_dark','&Dark\tCtrl+Alt+D')
...
_accels = [
    ...
    (FVIRTKEY|FCONTROL|FSHIFT, 0x56, 1306),           # Ctrl+Shift+V Markdown preview
    (FVIRTKEY|FCONTROL|FSHIFT, 0x4F, 1307),           # Ctrl+Shift+O Outline
    (FVIRTKEY|FCONTROL|FALT, 0x4C, 1310),             # Ctrl+Alt+L Light
    (FVIRTKEY|FCONTROL|FALT, 0x44, 1311),             # Ctrl+Alt+D Dark
    (FVIRTKEY|FCONTROL, 0x31, 1401),                  # Ctrl+1 Heading 1
    (FVIRTKEY|FCONTROL, 0x32, 1402),                  # Ctrl+2 Heading 2
    (FVIRTKEY|FCONTROL, 0x42, 1403),                  # Ctrl+B Bold
...
imports = {
    'KERNEL32.dll': [
        ...
        'MultiByteToWideChar','WideCharToMultiByte','lstrcpyW','lstrlenW','GetModuleHandleW','CompareStringOrdinal','LoadLibraryW','MulDiv'
    ],
    'USER32.dll': [
        ...
        'DestroyWindow','ShowWindow','CheckMenuItem','GetWindowRect','wsprintfW','RegisterWindowMessageW','InvalidateRect','UpdateWindow',
    ...
    'GDI32.dll': ['CreateFontW','DeleteObject','CreateSolidBrush','SetTextColor','SetBkColor'],
...
class E:
    ...
    def movzx_r32_word_index2(self,dst,base,index):
        ...
        self.emit(0x0F,0xB7,0x04,0x40|((i&7)<<3)|(b&7))
...
em.xor32('rcx'); em.lea_rip('rdx',rsyms['class_richedit']); em.lea_rip('r8',rsyms['empty']); em.mov_r32_imm('r9',0x40A11844)
...
em.xor32('rcx'); em.lea_rip('rdx',rsyms['class_listbox']); em.lea_rip('r8',rsyms['empty']); em.mov_r32_imm('r9',0x50A10101)
...
for cid,label in [(1001,'cmd_new'),(1002,'cmd_open'),(1003,'cmd_save'),(1004,'cmd_saveas'),(1005,'cmd_exit'),
                  ...
                  (1301,'cmd_zoomin'),(1302,'cmd_zoomout'),(1303,'cmd_zoomreset'),(1304,'cmd_wrap'),(1305,'cmd_status'),(1306,'cmd_preview'),(1307,'cmd_outline'),(1310,'cmd_light'),(1311,'cmd_dark'),
...
em.label('cmd_md_link'); em.lea_rip('r10',rsyms['md_link_pre']); em.lea_rip('r11',rsyms['md_link_post']); em.call_label('md_wrap_selection'); em.call_label('update_preview'); em.call_label('update_status'); em.jmp('msg_loop')
...
# Helper: add the current heading to the left outline. It reads heading_* state from BSS.
...
em.lea_rip('r11',bsyms['charfmt']); em.mov_mreg_imm32('r11',0,92); em.mov_mreg_imm32('r11',4,0xE0000000); em.mov_mreg_imm32('r11',8,0)
...
# 13 quote, 14 link, 15 fenced code block.
em.label('apply_styles')
em.emit(0x41,0x54); em.emit(0x41,0x55); em.emit(0x48,0x83,0xEC,0x28)  # push r12,r13
em.xor32('r12')
em.label('style_loop')
...
# initialize CHARFORMAT header; individual branches fill mask/effects/size/color/face.
em.lea_rip('r11',bsyms['charfmt']); em.mov_mreg_imm32('r11',0,92); em.mov_mreg_imm32('r11',8,0)
# Headings 1..6.
em.cmp_r32_imm('r13',6); em.jcc(0x87,'style_nonheading')
em.cmp_r32_imm('r13',1); em.jcc(0x82,'style_nonheading')
em.mov_mreg_imm32('r11',4,0x80000001); em.mov_mreg_imm32('r11',8,1)
for lvl,tw in [(1,480),(2,400),(3,340),(4,300),(5,260),(6,240)]:
    em.cmp_r32_imm('r13',lvl); em.jcc(0x84,f'style_h{lvl}')
em.mov_r32_imm('rcx',240); em.jmp('style_heading_size')
for lvl,tw in [(1,480),(2,400),(3,340),(4,300),(5,260),(6,240)]:
    em.label(f'style_h{lvl}'); em.mov_r32_imm('rcx',tw); em.jmp('style_heading_size')
...
em.jmp('style_next')
em.label('style_bold'); em.mov_mreg_imm32('r11',4,0x00000001); em.mov_mreg_imm32('r11',8,1); em.jmp('style_send')
em.label('style_italic'); em.mov_mreg_imm32('r11',4,0x00000002); em.mov_mreg_imm32('r11',8,2); em.jmp('style_send')
em.label('style_code'); em.mov_mreg_imm32('r11',4,0x60000000); em.mov_mreg_imm32('r11',8,0); em.mov_r32_ripmem('rax',bsyms['theme_dark']); em.test32('rax'); em.jcc(0x84,'style_code_light'); em.mov_mreg_imm32('r11',20,0x00E6B8AF); em.jmp('style_code_face')
em.label('style_code_light'); em.mov_mreg_imm32('r11',20,0x00803A6B)
em.label('style_code_face'); em.lea_rip('rcx',bsyms['charfmt']+26); em.lea_rip('rdx',rsyms['font_code']); em.call_iat('lstrcpyW'); em.jmp('style_send')
em.label('style_quote'); em.mov_mreg_imm32('r11',4,0x40000002); em.mov_mreg_imm32('r11',8,2); em.mov_r32_ripmem('rax',bsyms['theme_dark']); em.test32('rax'); em.jcc(0x84,'style_quote_light'); em.mov_mreg_imm32('r11',20,0x00AAAAAA); em.jmp('style_send')
em.label('style_quote_light'); em.mov_mreg_imm32('r11',20,0x006A6A6A); em.jmp('style_send')
em.label('style_link'); em.mov_mreg_imm32('r11',4,0x40000004); em.mov_mreg_imm32('r11',8,4); em.mov_r32_ripmem('rax',bsyms['theme_dark']); em.test32('rax'); em.jcc(0x84,'style_link_light'); em.mov_mreg_imm32('r11',20,0x00F0B070); em.jmp('style_send')
em.label('style_link_light'); em.mov_mreg_imm32('r11',20,0x00CC6600); em.jmp('style_send')
em.label('style_codeblock'); em.mov_mreg_imm32('r11',4,0x60000000); em.mov_mreg_imm32('r11',8,0); em.mov_r32_ripmem('rax',bsyms['theme_dark']); em.test32('rax'); em.jcc(0x84,'style_codeblock_light'); em.mov_mreg_imm32('r11',20,0x00DCDCDC); em.jmp('style_codeblock_face')
em.label('style_codeblock_light'); em.mov_mreg_imm32('r11',20,0x003C3C3C)
em.label('style_codeblock_face'); em.lea_rip('rcx',bsyms['charfmt']+26); em.lea_rip('rdx',rsyms['font_code']); em.call_iat('lstrcpyW')
...
# Remove any visible selection/caret highlight from the read-only preview.
...
# Reset outline and formatting state.
em.mov_ripmem_imm32(bsyms['style_count'],0); em.mov_ripmem_imm32(bsyms['heading_level'],0); em.mov_ripmem_imm32(bsyms['line_flags'],0)
...
em.mov_r64_ripmem('rcx',bsyms['hwnd_outline']); em.test64('rcx'); em.jcc(0x84,'pv_reset_done'); em.mov_r32_imm('rdx',0x0184); em.xor32('r8'); em.xor32('r9'); em.call_iat('SendMessageW')
em.label('pv_reset_done')
...
em.label('pv8_fence_lf'); em.mov_word_index2_reg('rdi','r13','rax'); em.add_r32_imm8('r13',1); em.add_r32_imm8('r12',1); em.mov_r32_imm('r14',1); em.jmp('pv8_loop')
...
em.mov_r32_r32('r10','r12'); em.add_r32_imm8('r10',1); em.movzx_r32_word_index2('r11','rsi','r10'); em.cmp_r32_imm('r11',0x20); em.jcc(0x85,'pv8_line_bullet')
em.mov_ripmem_imm32(bsyms['line_flags'],1); em.mov_ripmem_r32(bsyms['quote_out_start'],'r13'); em.add_r32_imm8('r12',2); em.xor32('r14'); em.jmp('pv8_loop')
...
em.label('pv8_bullet_check'); em.mov_r32_r32('r10','r12'); em.add_r32_imm8('r10',1); em.movzx_r32_word_index2('r11','rsi','r10'); em.cmp_r32_imm('r11',0x20); em.jcc(0x85,'pv8_normal_line')
em.mov_word_index2_imm16('rdi','r13',0x2022); em.add_r32_imm8('r13',1); em.mov_word_index2_imm16('rdi','r13',0x20); em.add_r32_imm8('r13',1); em.add_r32_imm8('r12',2); em.xor32('r14'); em.jmp('pv8_loop')
em.label('pv8_normal_line'); em.xor32('r14')

em.label('pv8_not_line_start')
# Fenced code content copies literally.
em.test32('r15'); em.jcc(0x85,'pv8_codeblock_copy')
em.movzx_r32_word_index2('rax','rsi','r12')
# LF finalizes line-scoped formatting and outline entries.
...
em.mov_ripmem_imm32(bsyms['bold_flag'],1); em.mov_ripmem_r32(bsyms['bold_out_start'],'r13'); em.add_r32_imm8('r12',2); em.jmp('pv8_loop')
...
em.mov_ripmem_imm32(bsyms['italic_flag'],1); em.mov_ripmem_r32(bsyms['italic_out_start'],'r13'); em.add_r32_imm8('r12',1); em.jmp('pv8_loop')
...
em.mov_ripmem_imm32(bsyms['inlinecode_flag'],1); em.mov_ripmem_r32(bsyms['code_out_start'],'r13'); em.add_r32_imm8('r12',1); em.jmp('pv8_loop')
...
em.mov_ripmem_imm32(bsyms['link_flag'],1); em.mov_ripmem_r32(bsyms['link_out_start'],'r13'); em.add_r32_imm8('r12',1); em.jmp('pv8_loop')
...
em.label('pv8_codeblock_copy'); em.movzx_r32_word_index2('rax','rsi','r12'); em.mov_word_index2_reg('rdi','r13','rax'); em.add_r32_imm8('r13',1); em.add_r32_imm8('r12',1); em.cmp_r32_imm('rax',0x0A); em.jcc(0x85,'pv8_loop'); em.mov_r32_imm('r14',1); em.jmp('pv8_loop')
...
em.label('pv8_lf_heading'); em.mov_r32_ripmem('r10',bsyms['heading_level']); em.test32('r10'); em.jcc(0x84,'pv8_lf_quote'); em.mov_ripmem_r32(bsyms['heading_out_end'],'r13'); em.mov_r32_ripmem('r8',bsyms['heading_out_start']); em.mov_r32_r32('r9','r13'); em.call_label('add_style'); em.call_label('add_outline_heading')
...
em.mov_r32_ripmem('r10',bsyms['heading_level']); em.test32('r10'); em.jcc(0x84,'pv8_eof_quote'); em.mov_ripmem_r32(bsyms['heading_out_end'],'r13'); em.mov_r32_ripmem('r8',bsyms['heading_out_start']); em.mov_r32_r32('r9','r13'); em.call_label('add_style'); em.call_label('add_outline_heading')
...
em.label('theme_del_outline'); em.mov_r64_ripmem('rcx',bsyms['hbrush_outline']); em.test64('rcx'); em.jcc(0x84,'theme_make'); em.call_iat('DeleteObject')
em.label('theme_make'); em.mov_r32_ripmem('rax',bsyms['theme_dark']); em.test32('rax'); em.jcc(0x84,'theme_make_light')
em.mov_r32_imm('rcx',0x001E1E1E); em.call_iat('CreateSolidBrush'); em.mov_ripmem_r64(bsyms['hbrush_edit'],'rax'); em.mov_r32_imm('rcx',0x00252526); em.call_iat('CreateSolidBrush'); em.mov_ripmem_r64(bsyms['hbrush_outline'],'rax'); em.jmp('theme_controls')
em.label('theme_make_light'); em.mov_r32_imm('rcx',0x00FFFFFF); em.call_iat('CreateSolidBrush'); em.mov_ripmem_r64(bsyms['hbrush_edit'],'rax'); em.mov_r32_imm('rcx',0x00F3F3F3); em.call_iat('CreateSolidBrush'); em.mov_ripmem_r64(bsyms['hbrush_outline'],'rax')
em.label('theme_controls')
# Status bar background and theme.
em.mov_r64_ripmem('rcx',bsyms['hwnd_status']); em.test64('rcx'); em.jcc(0x84,'theme_dwm'); em.mov_r32_imm('rdx',0x2001); em.xor32('r8'); em.mov_r32_ripmem('r9',bsyms['theme_dark']); em.test32('r9'); em.jcc(0x84,'theme_status_light'); em.mov_r32_imm('r9',0x00252526); em.jmp('theme_status_send')
em.label('theme_status_light'); em.mov_r32_imm('r9',0x00F3F3F3)
em.label('theme_status_send'); em.call_iat('SendMessageW')
em.mov_r64_ripmem('rcx',bsyms['hwnd_status']); em.mov_r32_ripmem('rax',bsyms['theme_dark']); em.test32('rax'); em.jcc(0x84,'theme_status_name_light'); em.lea_rip('rdx',rsyms['theme_dark_name']); em.xor32('r8'); em.call_iat('SetWindowTheme'); em.jmp('theme_dwm')
em.label('theme_status_name_light'); em.xor32('rdx'); em.xor32('r8'); em.call_iat('SetWindowTheme')
em.label('theme_dwm')
...
em.mov_r64_r64('rcx','r8'); em.mov_r32_imm('rdx',0x00D4D4D4); em.call_iat('SetTextColor'); em.mov_r64_ripmem('rcx',bsyms['paint_hdc']); em.mov_r32_imm('rdx',0x00252526); em.call_iat('SetBkColor'); em.mov_r64_ripmem('rax',bsyms['hbrush_outline']); em.add_r64_imm8('rsp',0x38); em.emit(0xC3)
...
out = '/mnt/data/direct_pe_markdown_editor_x64_v8.exe'
