...
FILE_ALIGN = 0x200
SECT_ALIGN = 0x1000
STYLE_CAP = 131072  # V8.4.18: large-doc Markdown style span capacity
...
wstr('title','Direct PE Markdown Editor x64 V8.4.18 — No Compiler')
wstr('empty','')
wstr('menu_file','&File')
wstr('menu_edit','&Edit')
...
# V8.4.18 deliberately does not crop or overlay the ListBox non-client scrollbar.
...
# V8.4.18: no scrollbar overlay child. The Outline's own themed ListBox scrollbar
...
# is near the divider. V8.4.18 leaves this non-client scrollbar completely native:
...
# V8.4.18 suppresses drawing while the non-client scrollbar is being materialized.
...
# V8.4.18: hard-isolate owner-drawn Outline rows from the native scrollbar gutter.
...
# safeRight = current Outline client right - 4px safety gap; when native scrollbar
# is visible reserve one full system scrollbar width as a permanent paint-free gutter.
...
em.mov_r32_ripmem('rax',bsyms['outline_scroll_visible']); em.test32('rax'); em.jcc(0x84,'outline_clip_safe_ready')
em.mov_r32_ripmem('r11',bsyms['scrollbar_w']); em.sub_r32_r32('r10','r11')
em.label('outline_clip_safe_ready')
...
out = '/mnt/data/direct_pe_markdown_editor_x64_v8_4_18.exe'
